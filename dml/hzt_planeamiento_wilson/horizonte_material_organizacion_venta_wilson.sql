...
SELECT
  ...
  cod_marca,
  des_marca,
  cod_unidad_comercial_organizacion_venta,
  cod_unidad_comercial_material,
  cod_unidad_base,
  num_numerador_conversion_unidad_comercial,
  num_denominador_conversion_unidad_comercial,
  cod_indicador_impuesto,
  des_indicador_impuesto,
  cod_clasificacion_impuesto_1,
  cod_clasificacion_impuesto_2,
  cod_clasificacion_impuesto_3,
  flg_clasificacion_impuesto,
  cod_centro_beneficio,
  val_centro_beneficio_digito_567,
  fec_creacion_material,
  cod_usuario_creador,
  fec_ultima_modificacion,
  cod_usuario_ultima_modificacion,
  flg_fert_hawa,
  cod_estado_fert_hawa,
  flg_racionalizacion_caso_uso_03,
  cod_tier,
  des_tier,
  des_equipo_creador,
  cod_estado_nuevo,
  flg_exclusion_categoria_valorizacion,
  est_relacion_familia_marca,
  flg_sociedad,
  flg_mrp_activo,
  cod_jerarquia_material,
  cod_material
