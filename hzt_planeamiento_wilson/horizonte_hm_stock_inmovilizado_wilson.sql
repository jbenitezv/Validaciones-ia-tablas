...
,stock_inmovilizados_base as (
 select 
  ...
  CASE WHEN TRIM(COALESCE(a.flg_cuadrante,'')) != '' THEN TRUE ELSE FALSE END AS num_cuadrante,
  ...
  CASE WHEN TRIM(COALESCE(a.flg_racionalizado,'')) != '' THEN TRUE ELSE FALSE END AS est_racionalizado,
  a.est_ejecutado,
