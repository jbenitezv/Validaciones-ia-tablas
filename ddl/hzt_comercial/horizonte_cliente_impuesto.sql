...
CREATE OR REPLACE TABLE `{horizonte_project_id}.hzt_comercial.horizonte_cliente_impuesto`(
  ...
  cod_pais_impuesto STRING OPTIONS(description="Código de país asociado al impuesto"),
  cod_categoria_impuesto STRING OPTIONS(description="Código de categoría del impuesto"),
  cod_clasificacion_impuesto STRING OPTIONS(description="Código de clasificación del impuesto (0/1 exonerado, 2 gravado, etc.)"),
  ...
  flg_igv BOOL OPTIONS(description="TRUE si la clasificación del impuesto corresponde a IGV"),
