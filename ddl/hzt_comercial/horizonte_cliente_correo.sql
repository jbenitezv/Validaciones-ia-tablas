...
create or replace table `{horizonte_project_id}.hzt_comercial.horizonte_cliente_correo`(
  ...
  des_comentario_correo STRING OPTIONS(description="Comentario o etiqueta del correo (ej. FE-PE11)"),
  cod_interno_correo STRING OPTIONS(description="Identificador interno del correo"),
  val_correo_cliente STRING OPTIONS(description="Dirección de correo electrónico del cliente"),
